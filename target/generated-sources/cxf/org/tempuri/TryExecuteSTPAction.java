 ...
 *         &lt;element name="flags" type="{http://schemas.datacontract.org/2004/07/Egar.Focus.Interface}InterActionParams" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "TryExecuteSTPAction")
public class TryExecuteSTPAction {
    ...
    @XmlElementRef(name = "flags", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<InterActionParams> flags;
     ...
     *     
     */
    public JAXBElement<InterActionParams> getFlags() {
        return flags;
    }
     ...
     *     
     */
    public void setFlags(JAXBElement<InterActionParams> value) {
        this.flags = value;
    }
