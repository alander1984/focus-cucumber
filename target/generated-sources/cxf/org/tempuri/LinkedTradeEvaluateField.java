...
@XmlRootElement(name = "LinkedTradeEvaluateField")
public class LinkedTradeEvaluateField {
    ...
    @XmlElementRef(name = "field", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
