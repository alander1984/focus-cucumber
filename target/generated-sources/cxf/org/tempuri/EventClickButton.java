 ...
 *         &lt;element name="buttonName" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "EventClickButton")
public class EventClickButton {
    ...
    @XmlElementRef(name = "buttonName", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> buttonName;
     ...
     *     
     */
    public JAXBElement<String> getButtonName() {
        return buttonName;
    }
     ...
     *     
     */
    public void setButtonName(JAXBElement<String> value) {
